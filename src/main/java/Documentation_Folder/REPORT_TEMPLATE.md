...
## Project Title
Weam Platform for Children with Disabilities
...
## Proposed Solution
Weam is a Java Swing desktop platform that allows all care team members to share reports, appointments, updates, and notifications in one place.
