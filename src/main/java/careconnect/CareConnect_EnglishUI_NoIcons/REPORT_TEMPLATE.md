...
The interface is fully English to keep the dashboard clean and readable.
...
- Custom child picture
- Purple and peach-pink visual theme
...
- No unnecessary text icons in the interface
